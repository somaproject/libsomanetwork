#ifndef SOMANETWORK_LOSSYDATARECEIVER_H
#define SOMANETWORK_LOSSYDATARECEIVER_H
...
typedef std::queue<pDataPacket_t> dataPacketpQueue_t; 
  ...
  /*
    The Lossy Data Receiver is just like the dataReceiver but it does not
    reorder packets or request retransmission
  ...
  */
  ...
  class LossyDataReceiver : public PacketReceiver
{
  
public:
  LossyDataReceiver(eventDispatcherPtr_t pDispatch, 
  ...
  LossyDataReceiverStats getStats(); 
  void resetStats(); 
